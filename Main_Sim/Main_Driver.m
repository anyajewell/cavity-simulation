...
for i = 1:Nz-1
    ...
    if pos + dz > Zmax % propagate by fractional step to L
        dz1 = L-z(i); % fractional dz
        ...
        dz = -dz; % officially heading the other direction
    elseif pos + dz == Zmax % step brings beam exactly to the mirror (don't see how this would happen at this point)
